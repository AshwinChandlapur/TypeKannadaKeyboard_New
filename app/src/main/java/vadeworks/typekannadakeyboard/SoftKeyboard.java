...
package vadeworks.typekannadakeyboard;
...
public class SoftKeyboard extends InputMethodService
    ...
    private int EngOrKan; //If English then 1, if Kannada then 0
    ...
    public void onInitializeInterface() {
        ...
        mKannadaKeyboard = new LatinKeyboard(this,R.xml.kannada_keyboard);
    }
    ...
    public View onCreateInputView() {
        ...
        mInputView.setPreviewEnabled(false); //Remember: This sets a popUp for the key user presses
...
//            updateCandidates();
    ...
    private void handleLanguageSwitch() {
        if(EngOrKan ==1)//Means If it is English Keyboard
        {
